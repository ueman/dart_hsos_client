...
const CustomBase64Codec customBase64 = CustomBase64Codec();
...
const CustomBase64Codec base64Url = CustomBase64Codec.urlSafe();
...
/// A [base64](https://tools.ietf.org/html/rfc4648) encoder and decoder.
///
/// A [CustomBase64Codec] allows base64 encoding bytes into ASCII strings and
...
/// characters.
class CustomBase64Codec extends Codec<List<int>, String> {
  final CustomBase64Encoder _encoder;
  const CustomBase64Codec() : _encoder = const CustomBase64Encoder();
  const CustomBase64Codec.urlSafe() : _encoder = const CustomBase64Encoder.urlSafe();

  CustomBase64Encoder get encoder => _encoder;
  ...
  String normalize(String source, [int start = 0, int end]) {
    ...
    var alphabet = _CustomBase64Encoder._base64Alphabet;
...
class CustomBase64Encoder extends Converter<List<int>, String> {
  final bool _urlSafe;

  const CustomBase64Encoder() : _urlSafe = false;
  const CustomBase64Encoder.urlSafe() : _urlSafe = true;

  String convert(List<int> input) {
    if (input.isEmpty) return "";
    var encoder = _CustomBase64Encoder(_urlSafe);
...
class _CustomBase64Encoder {
  static const String customAlphabet =
      "ipkIBozSlL8CVH3J7PvQfWYuemxOcR4rn5bgDUqMaKXTy60h9wt-NZdjFAE12Gs.";

  static const String defaultBase64Alphabet =
      "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";


  /// The RFC 4648 base64 encoding alphabet.
  static const String _base64Alphabet = customAlphabet;
  ...
  _CustomBase64Encoder(bool urlSafe)
...
class _BufferCachingBase64Encoder extends _CustomBase64Encoder {
  /// Reused buffer.
  ///
...
class _AsciiBase64EncoderSink extends _Base64EncoderSink {
  ...
  final _CustomBase64Encoder _encoder;
...
class _Utf8Base64EncoderSink extends _Base64EncoderSink {
  ...
  _Utf8Base64EncoderSink(this._sink, bool urlSafe)
      : _encoder = _CustomBase64Encoder(urlSafe);
